...
parser.add_argument('--gpu_num', dest='gpu_num', default="0", help='which GPU to use')
parser.add_argument('--gpu_frac', dest='gpu_frac', type=float, default=1, help='weight on L1 term in objective')
args = parser.parse_args()

os.environ["CUDA_VISIBLE_DEVICES"] = args.gpu_num
print("GPU_NUM=%s GPU_FRAC=%2f" %(os.environ.get('CUDA_VISIBLE_DEVICES'),args.gpu_frac))
if args.gpu_frac < 1:
    KTF.set_session(get_session(args.gpu_frac))
